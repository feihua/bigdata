...
```shell
vim /opt/module/flume/conf/kafka_to_hdfs.conf
```
```text
a1.sources = r1
a1.channels = c1
...
**启动**
```shell
/opt/module/flume/bin/flume-ng agent -n a1 -c /opt/module/flume/conf/ -f /opt/module/flume/conf/kafka_to_hdfs.conf
```
